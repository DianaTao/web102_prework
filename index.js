...
const descriptionStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} game${GAMES_JSON.length === 1 ? '' : 's'}. Currently, ${numUnfundedGames} game${numUnfundedGames === 1 ? ' remains' : 's remain'} unfunded. We need your help to fund these amazing games!`;
